...
namespace DNX {
    namespace App {
        ...
        class AppOptionsParser {
            ...
            static bool HandleParameter(AppOptions& options, int position, string value);
            static void HandleOption(AppOptions& options, string optionName, string value);
            static bool HandleSwitch(AppOptions& options, string optionName, bool switchOn);
            ...
            static list<string> ReadLinesFromFile(string fileName, AppOptions& options);
