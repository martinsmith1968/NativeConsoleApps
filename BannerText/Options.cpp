...
class Options final : public AppOptions
{
    ...
    Options()
    {
        AddOption(OptionType::PARAMETER, ValueType::STRING, "text", "message-text", "", "The Text to display", true);
        AddOption(OptionType::OPTION, ValueType::CHAR, "hlc", "header-line-char", "*", "The character to use for header lines", false);
        AddOption(OptionType::OPTION, ValueType::INT, "hln", "header-line-count", "1", "The number of header lines to print", false);
        AddOption(OptionType::OPTION, ValueType::CHAR, "flc", "footer-line-char", "*", "The character to use for footer lines", false);
        AddOption(OptionType::OPTION, ValueType::INT, "fln", "footer-line-count", "1", "The number of footer lines to print", false);
        AddOption(OptionType::OPTION, ValueType::CHAR, "tlc", "text-line-char", "*", "The character to use for text line prefix/suffix", false);
        AddOption(OptionType::OPTION, ValueType::INT, "tpc", "title-prefix-count", "2", "Set Title Prefix Count", false);
        AddOption(OptionType::OPTION, ValueType::INT, "tsc", "title-suffix-count", "2", "Set Title Suffix Count", false);
